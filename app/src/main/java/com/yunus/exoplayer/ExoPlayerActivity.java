...
public class ExoPlayerActivity extends AppCompatActivity implements Player.EventListener {
    ...
    private ImageView imgTabLayout;
    private ImageView imgVideoAds;
    ...
    private void initLayout(){
        imgTabLayout = findViewById(R.id.imgTabLayout);
        imgVideoAds = findViewById(R.id.imgAds);
    ...
    private void initEvent(){
       imgTabLayout.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               startActivity(new Intent(ExoPlayerActivity.this,TabLayoutActivity.class));
           }
       });

       imgVideoAds.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               Toast.makeText(getApplicationContext(),"Putar Iklan",Toast.LENGTH_SHORT).show();
           }
       });
